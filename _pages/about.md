...
- Pedersen, K.A. *Making a deal with the devil: How the relationship between the regime and news media affects news content in an electoral autocracy.* Working paper.  Presented at EPSA 2022, DPSA 2022, and APSA 2023.
  <details>
    ...
    Using a differences-in-differences design and an original dataset of local news
    broadcasts from across Russia, I estimate the effects of winning and participating in
    regime-sponsored tenders on pro-regime bias in news content. I find that winners
    increased pro-regime bias in their news coverage, particularly companies operating
    in more competitive local markets. I also present descriptive evidence that outlets increased
...
Presented at EPSA 2024, APSA 2024, the CBS-Princeton Money in Politics Conference 2025, and EUI Digital Inequalities Conference Fall 2025.
  <details>
    ...
    temporal variation in Russian “foreign agent” labeling to investigate how repression
    impacts political expression online in (1) the content produced by those labeled as
    political pariahs, and (2) the user engagement with the “suspect” content. To do this,
    we employ a staggered difference-in-differences design on videos posted by YouTubers
    designated as “foreign agents” in Russia (>200,000 videos), and the adjacent comments
    left by viewers (>130,000,000 comments). Our findings suggest that targeted actors not
    only retain their online presence but also increase the level of regime criticism in their
    content. Simultaneously, we show that audience engagement dropped substantially
    among actors branded as politically deviant by the regime. Finally, users appear
    to increase the use of symbols when engaging with targeted channels. These results
    indicate that regime deterrence signals can be effective in stifling online engagement
...
- Pedersen, K. A. (2025). *Online political expression under censorship: when backlash is short-lived.* Working paper. Presented at EPSA 2023, IC2S2 2023, and EPSA 2025.
  <details>
    ...
    prevails. This paper analyzes how overt and repressive censorship shapes online discourse
    in times of political unrest. Using Russia’s full-scale invasion of Ukraine and
    subsequent authoritarian consolidation as a case, this paper studies over 4,500,000
    comments across different pro and anti-regime-leaning YouTube channels targeted
    toward Russian-speaking audiences. I use an embedding-based topic model to conduct
    a descriptive analysis of changes in online discourse in the days following the
    invasion as well as the introduction of Russia’s censorship law in March 2022. The
    results suggest that discourse on collective action nearly doubled at the start of the invasion.
    However, both discourse on collective action and criticism of the war sharply
    dropped as the law was introduced. In sum, the findings indicate that Russia’s invasion
    of Ukraine initially triggered (online) backlash but that the regime swiftly curtailed
    the dissent through the implementation of overt and repressive censorship.
    This showcases how regimes can successfully balance sparks of unrest by doubling
